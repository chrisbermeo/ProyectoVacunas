...
class UserSqliteOpenHelper(context: Context, name: String, factory: SQLiteDatabase.CursorFactory?, version: Int) : SQLiteOpenHelper(context, name, factory,version){
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        db.execSQL( "CREATE TABLE turno(id_turno integer primary key autoincrement, fk_id_usuario integer references usuario(id_usuario), tipo_vacuna text, centro_acopio text, url_maps text, fecha text, hora text )")
    }
